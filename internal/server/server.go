...
import (
	...
	"github.com/ozonmp/trv-airport-api/internal/api"
...
func (s *GrpcServer) Start(cfg *config.Config) error {
	...
	r := repo.NewAirportRepo(s.db, s.batchSize)

	pb.RegisterTrvAirportApiServiceServer(grpcServer, api.NewAirportAPI(r))
